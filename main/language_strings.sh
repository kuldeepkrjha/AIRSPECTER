...
function initialize_language_strings() {
	...
	arr["ENGLISH",6]="Airspecter"
	arr["ENGLISH",9]="System detection ongoing..."
	...
	arr["ENGLISH",24]="Choose an interface to use:"
	...
	arr["ENGLISH",48]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color}  Network interface Menu"
	arr["ENGLISH",49]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color}  Discover targets. ${red_color}[${yellow_color}monitor mode needed${red_color}]${normal_color}"
	arr["ENGLISH",50]="\${yellow_color}monitor mode needed for attacks"
	arr["ENGLISH",51]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}  \${mdk_command} deauth/disassoc amok attack"
	arr["ENGLISH",52]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  Deauth aireplay attack"
	arr["ENGLISH",53]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  WIDS / WIPS / WDS Confusion attack"
	arr["ENGLISH",54]="${yellow_color}old \"obsolete/non very effective\" attacks"
	arr["ENGLISH",55]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color}  Enable monitor mode"
	arr["ENGLISH",56]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color}  Enable managed mode "
	arr["ENGLISH",57]="${red_color}[${yellow_color}10${red_color}]${lightcyan_color}Enterprise attacks menu"
	...
	arr["ENGLISH",78]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color}  Change language"
	...
	arr["ENGLISH",108]="[Confirm installed dependencies.]"
	arr["ENGLISH",109]="Essential tools: checking..."
	arr["ENGLISH",110]="Script can proceed. All tools available..."
	...
	arr["ENGLISH",115]="${pink_color}Press Enter..."
	arr["ENGLISH",116]="4.  Catalan"
	arr["ENGLISH",117]="\${yellow_color}smooth mode, disconnect on capture"
	arr["ENGLISH",118]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color}  DoS attacks menu"
	arr["ENGLISH",119]="${red_color}[${yellow_color}8${red_color}]${lightcyan_color}  Handshake/PMKID tools menu"
	arr["ENGLISH",120]="Handshake/PMKID tools menu"
	arr["ENGLISH",121]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  Capture Handshake"
	arr["ENGLISH",122]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  Clean/optimize Handshake file"
	...
	arr["ENGLISH",139]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color}  Deauth / disassoc amok \${mdk_command} attack"
	arr["ENGLISH",140]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color}  Deauth aireplay attack"
	arr["ENGLISH",141]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color}  WIDS / WIPS / WDS Confusion attack"
	...
	arr["ENGLISH",147]="${red_color}[${yellow_color}0${red_color}]  Return to Handshake tools menu"
	...
	arr["ENGLISH",169]="${red_color}[${yellow_color}9${red_color}]${lightcyan_color}  Offline WPA/WPA2 decrypt menu"
	...
	arr["ENGLISH",172]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color}  (aircrack) Dictionary attack against Handshake/PMKID capture file"
	...
	arr["ENGLISH",175]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color}  (aircrack + crunch) Bruteforce attack against Handshake/PMKID capture file"
	...
	arr["ENGLISH",197]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color}  Lowercase chars"
	arr["ENGLISH",198]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color}  Uppercase chars"
	arr["ENGLISH",199]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color}  Numeric chars"
	arr["ENGLISH",200]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color}  Symbol chars"
	arr["ENGLISH",201]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}  Lowercase + uppercase chars"
	arr["ENGLISH",202]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  Lowercase + numeric chars"
	arr["ENGLISH",203]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  Uppercase + numeric chars"
	arr["ENGLISH",204]="${red_color}[${yellow_color}8${red_color}]${lightcyan_color}  Symbol + numeric chars"
	arr["ENGLISH",205]="${red_color}[${yellow_color}9${red_color}]${lightcyan_color}  Lowercase + uppercase + numeric chars"
	arr["ENGLISH",206]="${red_color}[${yellow_color}10${red_color}]${lightcyan_color} Lowercase + uppercase + symbol chars"
	arr["ENGLISH",207]="${red_color}[${yellow_color}11${red_color}]${lightcyan_color} Lowercase + uppercase + numeric + symbol chars"
	...
	arr["ENGLISH",230]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color}  (hashcat) Dictionary attack against Handshake capture file"
	arr["ENGLISH",231]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color}  (hashcat) Bruteforce attack against Handshake capture file"
	arr["ENGLISH",232]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}  (hashcat) Rule based attack against Handshake capture file"
	...
	arr["ENGLISH",246]="Every time you see a text with the prefix \${yellow_color}\${pending_of_translation}\${pink_color} acronym for \"Pending of Translation\", means the translation has been automatically generated and is still pending of review"
	...
	arr["ENGLISH",256]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}  Evil Twin attack just AP"
	...
	arr["ENGLISH",259]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  Evil Twin AP attack with sniffing"
	arr["ENGLISH",260]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  Smooth mode Enterprise Evil Twin"
	arr["ENGLISH",261]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  Evil Twin AP attack with sniffing and bettercap-sslstrip2"
	arr["ENGLISH",262]="\${yellow_color}without sniffing, captive portal"
	arr["ENGLISH",263]="${red_color}[${yellow_color}9${red_color}]${lightcyan_color}  Evil Twin AP attack with captive portal (monitor mode needed)"
	...
	arr["ENGLISH",266]="${red_color}[${yellow_color}0${red_color}]${lightcyan_color}  Return to Evil Twin attacks menu"
	...
	arr["ENGLISH",307]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  Noisy mode Enterprise Evil Twin"
	...
	arr["ENGLISH",333]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  WPS attacks menu"
	...
	arr["ENGLISH",345]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}  (bully) Custom PIN association"
	arr["ENGLISH",346]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  (bully) Pixie Dust attack"
	arr["ENGLISH",347]="${red_color}[${yellow_color}9${red_color}]${lightcyan_color}  (bully) Bruteforce PIN attack"
	arr["ENGLISH",348]="${red_color}[${yellow_color}11${red_color}]${lightcyan_color} (bully) Known PINs database based attack"
	...
	arr["ENGLISH",357]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  (reaver) Custom PIN association"
	arr["ENGLISH",358]="${red_color}[${yellow_color}8${red_color}]${lightcyan_color}  (reaver) Pixie Dust attack"
	arr["ENGLISH",359]="${red_color}[${yellow_color}10${red_color}]${lightcyan_color} (reaver) Bruteforce PIN attack"
	arr["ENGLISH",360]="${red_color}[${yellow_color}12${red_color}]${lightcyan_color} (reaver) Known PINs database based attack"
	...
	arr["ENGLISH",396]="${red_color}[${yellow_color}8${red_color}]${lightcyan_color}  Evil Twin AP attack with sniffing and bettercap-sslstrip2/BeEF"
	...
	arr["ENGLISH",409]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color}  Evil Twin AP attack with sniffing and bettercap-sslstrip2/BeEF"
	arr["ENGLISH",410]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color}  Try to troubleshoot manually installed BeEF dependency problem"
	...
	arr["ENGLISH",423]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}  WEP \"All-in-One\" attack"
	...
	arr["ENGLISH",426]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  WEP attacks menu"
	...
	arr["ENGLISH",444]="${red_color}[${yellow_color}12${red_color}]${lightcyan_color} Options and language menu"
	...
	arr["ENGLISH",446]="${red_color}[${yellow_color}0${red_color}]${lightcyan_color}  Return to options menu"
	...
	arr["ENGLISH",521]="${red_color}[${yellow_color}0${red_color}]${lightcyan_color}  Return to Enterprise attacks menu"
	...
	arr["ENGLISH",545]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color} (john the ripper) Dictionary attack against capture file"
	arr["ENGLISH",546]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color}  (john the ripper + crunch) Bruteforce attack against capture file"
	...
	arr["ENGLISH",549]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  (asleap) Challenge/response dictionary attack"
	arr["ENGLISH",550]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color}  (hashcat) Dictionary attack against capture file"
	arr["ENGLISH",551]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color}  (hashcat) Bruteforce attack against capture file"
	arr["ENGLISH",552]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}}  (hashcat) Rule based attack against capture file"
	...
	arr["ENGLISH",556]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color}  Enable basic colorization permanently"
	arr["ENGLISH",557]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color}  Disable basic colorization permanently"
	...
	arr["ENGLISH",565]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color}  Disable skip intro permanently"
	arr["ENGLISH",566]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color}  Enable skip intro permanently"
	...
	arr["ENGLISH",573]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  Disable silent checks permanently"
	arr["ENGLISH",574]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  Enable silent checks permanently"
	...
	arr["ENGLISH",584]="${red_color}[${yellow_color}8${red_color}]${lightcyan_color}  Disable print hints permanently"
	arr["ENGLISH",585]="${red_color}[${yellow_color}8${red_color}]${lightcyan_color}  Enable print hints permanently"
	...
	arr["ENGLISH",592]="${red_color}[${yellow_color}9${red_color}]${lightcyan_color}  Disable 5Ghz permanently"
	arr["ENGLISH",593]="${red_color}[${yellow_color}9${red_color}]${lightcyan_color}  Enable 5Ghz permanently"
	...
	arr["ENGLISH",616]="${red_color}[${yellow_color}10${red_color}]${lightcyan_color} Change windows handling method to tmux"
	arr["ENGLISH",617]="${red_color}[${yellow_color}10${red_color}]${lightcyan_color} Change windows handling method to xterm"
	...
	arr["ENGLISH",622]="${red_color}[${yellow_color}13${red_color}]${lightcyan_color} (reaver) Null PIN attack"
	...
	arr["ENGLISH",637]="${red_color}[${yellow_color}11${red_color}]${lightcyan_color} Set mdk version to mdk3"
	arr["ENGLISH",638]="${red_color}[${yellow_color}11${red_color}]${lightcyan_color} Set mdk version to mdk4"
	...
	arr["ENGLISH",651]="${red_color}[${yellow_color}12${red_color}]${lightcyan_color} Disable plugins system permanently"
	arr["ENGLISH",652]="${red_color}[${yellow_color}12${red_color}]${lightcyan_color} Enable plugins system permanently"
	...
	arr["ENGLISH",663]="${red_color}[${yellow_color}5${red_color}]${lightcyan_color}  Capture PMKID"
	...
	arr["ENGLISH",668]="${red_color}[${yellow_color}6${red_color}]${lightcyan_color}  (hashcat) Dictionary attack against PMKID capture file"
	arr["ENGLISH",669]="${red_color}[${yellow_color}7${red_color}]${lightcyan_color}  (hashcat) Bruteforce attack against PMKID capture file"
	arr["ENGLISH",670]="${red_color}[${yellow_color}8${red_color}]${lightcyan_color}  (hashcat) Rule based attack against PMKID capture file"
	...
	arr["ENGLISH",688]="${red_color}[${yellow_color}13${red_color}]${lightcyan_color} Disable Network Manager force stop permanently"
	arr["ENGLISH",689]="${red_color}[${yellow_color}13${red_color}]${lightcyan_color} Enable Network Manager force stop permanently"
	...
	arr["ENGLISH",715]="${red_color}[${yellow_color}1${red_color}]${lightcyan_color} Bettercap"
	arr["ENGLISH",716]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color} Ettercap"
	arr["ENGLISH",717]="${red_color}[${yellow_color}10${red_color}]${lightcyan_color} Tools menu${yellow_color}(Other)"
	arr["ENGLISH",718]="${red_color}[${yellow_color}2${red_color}]${lightcyan_color} Beef"
	arr["ENGLISH",719]="${red_color}[${yellow_color}3${red_color}]${lightcyan_color} ReconDog"
	arr["ENGLISH",720]="${red_color}[${yellow_color}4${red_color}]${lightcyan_color} SQLmap"
