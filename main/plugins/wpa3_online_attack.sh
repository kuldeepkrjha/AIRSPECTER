...
function wpa3_attacks_menu() {
	...
	read -rp "$(echo -e "${blue_color}[${green_color}Airspector${blue_color}]-${blue_color}$")" wpa3_option
	case ${wpa3_option} in
		0)
			return
		;;
...
function wpa3_online_attack_prehook_remove_warnings() {
	...
	arr["ENGLISH","wpa3_online_attack_1"]="${red_color}[${yellow_color}12${red_color}]${cyan_color} WPA3 attacks menu"
	...
	arr["ENGLISH","wpa3_online_attack_3"]="${red_color}[${yellow_color}5${red_color}]${cyan_color} WPA3 online dictionary attack"
